...
RUN ["java", "-XX:+UseAppCDS", "-Xshare:dump", "-XX:DumpLoadedClassList=classes.lst", "-XX:SharedArchiveFile=/opt/app/app-cds.jsa", "--class-path", "/opt/app/netty-example-1.0-SNAPSHOT.jar"]
